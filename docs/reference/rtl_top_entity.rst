...
.. list-table::
   ...
   * - ``Hardware`` (ZCU208)
     - submodule (``axi_soc_ultra_plus_core.hardware.XilinxZcu208``)
...
.. list-table::
   ...
   * - ``dspClk``
     - 312.5 MHz
     - DSP / DAC sample bus (``Slv256Array``, 16 samples per cycle, 8 ch).
   * - ``adcClock``
     - 416.667 MHz
     - RFDC ADC output.
...
Sourced from
:repo:`firmware/targets/SimpleZcu208Example/hdl/SimpleZcu208Example.xdc`.
